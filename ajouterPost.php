...
require_once('functions.php');
        ...
        if(!empty($_POST))
        {
            ...
            if(count($errors) == 0)
            {
                $message = addArticle($userId, $title,$author,$message);
...
<head>
        ...
        <title>Ajoutez votre post classique</title>
</head>
<body>    
<nav>
        <ul class="navUl">
...
<div class="center">
                <h1 class="titrePosts">Postez un texte classique</h1>
</div>
...
<div class="center">
    <div class="divBoxTextePost">
        <form  method="post" >
                ...
                <br>
                <div class="center">
                <button class="containerBouton" type="submit">Poster</button>
                </div>
        </form>
    </div>
</div>
